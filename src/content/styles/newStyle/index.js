...
<div class="e404">
    ...
    <span>Zkuste se vrátit <a href="#" onclick="window.history.back()">zpátky</a></span>
        ...
        constructor() {
            ...
            link.setAttribute('href', chrome.extension.getURL('./themes/newStyle/404/' + theme + '.css'))
...
`
    ...
    NewStyle.Exam = class Exam extends NewStyle.Logged {
        constructor() {
            super()
    ...
    NewStyle.Main = class Main extends NewStyle.Logged {
...
<a href="${e[1]}" class="subject" style="order: ${order}" pttorder="${order}">
    ...
    NewStyle.Task = class Task extends NewStyle.Logged {
        constructor() {
            super()
        ...
        easterEgg() {
            ...
            if (document.getElementById('refProgress')) {
                ...
                if (document.querySelector("form > center > div.topLayout:nth-child(5) > div.outBox > table > tbody > tr.dropDownHeader > td.ltbOkSepCell")) {
                    try {
                        new Audio(chrome.runtime.getURL("./themes/newStyle/assets/turret.ogg")).play()
                    } catch { }
                }
            }
    ...
    NewStyle.Results = class Results extends NewStyle.Logged {
        constructor() {
            super()
    ...
    NewStyle.Course = class Course extends NewStyle.Logged {
        constructor() {
            super()
